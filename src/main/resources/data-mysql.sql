...
INSERT INTO app_user (id, role, nickname, avatar, phone, verified, city, categories, intro, experience_years, card_status, card_data, created_at)
...
INSERT INTO user_wallet (user_id, card_balance, member_level, ai_quota, updated_at)
...
INSERT INTO message_quota (user_id, remaining_count, total_count)
VALUES ('u_demo', 12, 20)
ON DUPLICATE KEY UPDATE user_id=VALUES(user_id);
...
INSERT INTO job_notice (id, title, job_type, category, salary_min, salary_max, salary_unit, salary_display, city, address, distance_km, longitude, latitude, duties, requirements, tags, publisher_id, publisher_name, publisher_avatar, publisher_real_name, publisher_enterprise, urgent, published_at, view_count, status, apply_count)
...
INSERT INTO conversation (id, role, name, avatar, last_message, last_time, unread)
...
INSERT INTO chat_message (id, conversation_id, content, message_type, from_me, created_at)
...
INSERT INTO employment_contract (id, anchor_name, company, job_title, amount, status, created_at)
VALUES ('ct_1001', '米粒', '杭州星耀文化传媒', '女装带货主播', 18000, 'ACTIVE', 1788249600000)
ON DUPLICATE KEY UPDATE id=VALUES(id);

INSERT INTO paid_invitation (id, company, anchor_name, job_title, fee, status, created_at)
VALUES ('iv_1001', '杭州星耀文化传媒', '米粒', '女装带货主播', 29.90, 'PENDING', 1788332400000)
ON DUPLICATE KEY UPDATE id=VALUES(id);

INSERT INTO course (id, name, mode, city, starts_at, capacity, enrolled, price, status)
...
INSERT INTO equipment_product (id, name, price, group_price, stock, participants, status)
...
INSERT INTO annual_event (id, name, city, event_date, status)
VALUES ('ev_2026', '2026 播聘年度主播盛典', '杭州', 1797436800000, 'REGISTRATION')
ON DUPLICATE KEY UPDATE id=VALUES(id);

INSERT INTO eor_provider (id, country, name, currencies, service_fee, rating, status)
